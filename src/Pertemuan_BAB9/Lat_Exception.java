...
public class Lat_Exception {
    public static void main (String[]args){
            try{
                ...
                System.out.println("Masukkan Anka 1 = ");
                a = Integer.parseInt(keyboard.next());
                System.out.println("Masukkan Anka 2 = ");
                ...
                JOptionPane.showMessageDialog(null, "Input anda masukkan huruf bukkan angka !! ", "Warning", 2);
            }finally {
